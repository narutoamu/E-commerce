  ...
  <div class="main_wrapper" >
    ...
    <div class="content_wrapper"> 
	  ...
	  <span style="float:right; font-size:18px; padding:5px line-height:40px;" align="center">Welcome Guest! <b style="color:yellow">Shopping cart-</b>
	    Total Price: Total Item: <?php total_items()?><a href="cart.php" style="color:yellow">Go to cart</a>
	   </span>
	    </div>
...
$count++;
	   ...
	   <a href='all_products.php?add_cart=$pro_id'><button style='float:right;'>Add to cart </a >
	   </div>";
	   
	 } 
	 if($count==0)
		 echo "<h2>There is no product available!</h2> ";
